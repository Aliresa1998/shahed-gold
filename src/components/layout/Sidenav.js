...
// import assets
import hrSideNav from "../../assets/images/hr-side-nav.svg";
...
function Sidenav({ color }) {
  ...
  return (
    <>
      {/* {
        !isAdmin && (
          <MainFBase checkToken={checkToken} />
        )
      } */}
            ...
            <NavLink to="/change-password">
              ...
              >
                <SettingOutlined
                  style={{
                    fontSize: "20px",
                    color: page != "change-password" ? "#BFBFC0" : "#FFF",
                  }}
                />
              </div>
              <span style={{ marginRight: "8px" }} className="label">
          ...
          <Menu.Item key="4">
            <NavLink to="/admin-messages">
              <div
                className="icon"
                style={{
                  background: page === "admin-messages" ? color : "",
                  display: "flex",
                  justifyContent: "center",
                  paddingRight: "6px",
                }}
